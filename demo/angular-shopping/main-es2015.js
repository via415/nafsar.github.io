...
HeaderComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: HeaderComponent, selectors: [["app-header"]], decls: 22, vars: 0, consts: [[1, "navbar", "navbar-expand-xl", "bg-light", "navbar-light"], ["href", "#", 1, "navbar-brand"], ["src", "./demo/angular-shopping/assets/images/tesla.png", "alt", "logo"], ["type", "button", "data-toggle", "collapse", "data-target", "#collapsibleNavbar", 1, "navbar-toggler"], [1, "navbar-toggler-icon"], ["id", "collapsibleNavbar", 1, "collapse", "navbar-collapse"], [1, "nav", "nav-tabs"], [1, "nav-item"], ["routerLink", "/shop", "routerLinkActive", "active text-primary btn-bck-color", 1, "nav-link"], ["matTooltip", "Coming Soon!", 1, "nav-item"], ["href", "#", 1, "nav-link", "disabled"], ["routerLink", "/support", "routerLinkActive", "active text-primary btn-bck-color", 1, "nav-link"]], template: function HeaderComponent_Template(rf, ctx) { if (rf & 1) {
...
class ProductComponent {
    constructor() {
        this.productItem = [
            new _product_model__WEBPACK_IMPORTED_MODULE_1__["ProductItem"](1, 'Model 3', 49500, './demo/angular-shopping/assets/images/model3.png'),
            new _product_model__WEBPACK_IMPORTED_MODULE_1__["ProductItem"](2, 'Model X', 90000, './demo/angular-shopping/assets/images/modelx.png'),
            new _product_model__WEBPACK_IMPORTED_MODULE_1__["ProductItem"](3, 'Model S', 70000, './demo/angular-shopping/assets/images/models.png'),
            new _product_model__WEBPACK_IMPORTED_MODULE_1__["ProductItem"](4, 'Model Y', 55000, './demo/angular-shopping/assets/images/modely.png'),
            new _product_model__WEBPACK_IMPORTED_MODULE_1__["ProductItem"](5, 'Cyber T', 65000, './demo/angular-shopping/assets/images/modelt.png'),
            new _product_model__WEBPACK_IMPORTED_MODULE_1__["ProductItem"](6, 'Sport R', 250000, './demo/angular-shopping/assets/images/modelr.png'),
            new _product_model__WEBPACK_IMPORTED_MODULE_1__["ProductItem"](7, 'Truck 1', 295000, './demo/angular-shopping/assets/images/rivian.png'),
            new _product_model__WEBPACK_IMPORTED_MODULE_1__["ProductItem"](8, 'Truck 2', 200000, './demo/angular-shopping/assets/images/semi.png'),
        ];
